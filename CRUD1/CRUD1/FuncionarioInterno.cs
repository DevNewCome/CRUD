...
namespace CRUD1
{
    class FuncionarioInterno: Funcionarios, Idados
    {


        private int diastrabalhados;
        private double salbas = 1500;
        private double totalreceber;



        public FuncionarioInterno(string nome, string telefone, string endereco, string cpf, string cargo)
        {
            this.nome = nome;
